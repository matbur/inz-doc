...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item $w^{(i)}$ - wektor wag i-tej warstwy,
        \item $x^{(i)}$ - wektor wejściowy.
    \end{itemize}
    ...
    Dodatkowo możemy przyjąć, że bias jest dodatkowym wejściem neuronu o wartości 1, jak pokazano w rówaniu~\ref{neuron-eq}.
